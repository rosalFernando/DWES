...
$curso = "DWES";
$mail = "a20derofe@iesgrancapitan.org";
$telefono = "111222333";
$LinkedIn = "Fernando del Rosal";
$twitter = "@noTengo";

$experienciaLaboral=array(
  array( "titulo" => "php developer",
  "descripcion" => "soy desarrollador"),
  array( "titulo" => "java developer",
  "descripcion" => "soy desarrollador"),
  array( "titulo" => "kotlin developer",
  "descripcion" => "soy desarrollador"),
  array( "titulo" => "Android developer",
  "descripcion" => "soy desarrollador"),
